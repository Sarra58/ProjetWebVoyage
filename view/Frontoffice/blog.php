...
<div class="super_container">
					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="#">actualités</a></li>
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<div class="logo menu_logo"><a href="#"><img src="images/logotripster.png" alt="Logo Tripster" height="125px" width="125px"></a></div>
			<ul>
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Le Blog</div>
		</div>
	</div>
			...
			<div class="row">
					...
					<div class="blog_post_container">
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="images/blog_1.jpg" alt="Vue sur la mer depuis une fenêtre">
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day">01</div>
									<div class="blog_post_month">Déc, 2017</div>
								</div>
							</div>
							<div class="blog_post_meta">
								<ul>
									<li class="blog_post_meta_item"><a href="">par Lore Papp</a></li>
									<li class="blog_post_meta_item"><a href="">Non classé</a></li>
									<li class="blog_post_meta_item"><a href="">3 Commentaires</a></li>
								</ul>
							</div>
							<div class="blog_post_title"><a href="#">Essayez ces nouvelles destinations de rêve</a></div>
							<div class="blog_post_text">
								<p>Découvrez nos nouvelles destinations de rêve qui vous feront voyager aux quatre coins du monde. Des plages paradisiaques des Maldives aux montagnes enneigées des Alpes, en passant par les villes historiques d'Europe, chaque destination a été soigneusement sélectionnée pour vous offrir une expérience unique. Profitez de nos offres exclusives et laissez-vous guider vers l'aventure de vos rêves.</p>
							</div>
							<div class="blog_post_link"><a href="#">lire la suite</a></div>
						</div>
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="images/blog_2.jpg" alt="Voyageur regardant une carte">
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day">01</div>
									<div class="blog_post_month">Déc, 2017</div>
								</div>
							...
							<div class="blog_post_title"><a href="#">Essayez ces nouvelles destinations de rêve</a></div>
							<div class="blog_post_text">
								<p>Plongez dans l'univers fascinant de nos destinations exotiques. Des safaris inoubliables en Afrique aux temples mystérieux d'Asie, en passant par les îles paradisiaques des Caraïbes, chaque voyage est une invitation à la découverte. Nos experts en voyage ont conçu des itinéraires uniques pour vous faire vivre des expériences authentiques et mémorables. Laissez-vous séduire par la magie de ces destinations exceptionnelles.</p>
							</div>
							<div class="blog_post_link"><a href="#">lire la suite</a></div>
						</div>
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="images/blog_3.jpg" alt="Bureau avec ordinateur portable et café">
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day">01</div>
									<div class="blog_post_month">Déc, 2017</div>
								</div>
							...
							<div class="blog_post_title"><a href="#">Essayez ces nouvelles destinations de rêve</a></div>
							<div class="blog_post_text">
								<p>Explorez nos destinations de luxe qui allient confort et authenticité. Des palaces prestigieux aux villas privées avec vue sur l'océan, en passant par les resorts exclusifs, chaque séjour est une expérience raffinée. Nos conseillers en voyage personnalisent chaque itinéraire pour vous offrir un séjour sur mesure, où chaque détail compte. Découvrez l'art de voyager avec élégance et sophistication.</p>
							</div>
							<div class="blog_post_link"><a href="#">lire la suite</a></div>
						</div>
				...
				<div class="col-lg-4 sidebar_col">
					...
					<div class="sidebar_search">
						<form action="#">
							<input id="sidebar_search_input" type="search" class="sidebar_search_input" placeholder="Rechercher..." required="required">
					...
					<div class="sidebar_categories">
						...
						<div class="sidebar_list">
							<ul>
								...
								<li><a href="#">Destinations Exotiques</a></li>
								<li><a href="#">Escapades Urbaines</a></li>
								<li><a href="#">Conseils de Voyage</a></li>
								<li><a href="#">Art de Vivre & Voyage</a></li>
								<li><a href="#">Escapades Urbaines</a></li>
					...
					<div class="sidebar_latest_posts">
						<div class="sidebar_title">Derniers Articles</div>
							...
							<ul>
								...
								<li class="latest_post clearfix">
									<div class="latest_post_image">
										<a href="#"><img src="images/latest_1.jpg" alt="Image dernier article 1"></a>
									</div>
									<div class="latest_post_content">
										<div class="latest_post_title trans_200"><a href="#">Un simple article de blog</a></div>
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">par Jane Smith</a></div>
											<div class="latest_post_date trans_200"><a href="#">25 Août, 2016</a></div>
										</div>
									</div>
								</li>
								...
								<li class="latest_post clearfix">
									<div class="latest_post_image">
										<a href="#"><img src="images/latest_2.jpg" alt="Image dernier article 2"></a>
									</div>
									<div class="latest_post_content">
										<div class="latest_post_title trans_200"><a href="#">Destination de rêve pour vous</a></div>
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">par Jane Smith</a></div>
											<div class="latest_post_date trans_200"><a href="#">25 Août, 2016</a></div>
										</div>
								...
								<li class="latest_post clearfix">
									<div class="latest_post_image">
										<a href="#"><img src="images/latest_3.jpg" alt="Image dernier article 3"></a>
									</div>
									<div class="latest_post_content">
										<div class="latest_post_title trans_200"><a href="#">Conseils pour voyager léger</a></div>
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">par Jane Smith</a></div>
											<div class="latest_post_date trans_200"><a href="#">25 Août, 2016</a></div>
										</div>
								...
								<li class="latest_post clearfix">
									<div class="latest_post_image">
										<a href="#"><img src="images/latest_4.jpg" alt="Image dernier article 4"></a>
									</div>
									<div class="latest_post_content">
										<div class="latest_post_title trans_200"><a href="#">Comment choisir vos vacances</a></div>
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">par Jane Smith</a></div>
											<div class="latest_post_date trans_200"><a href="#">25 Août, 2016</a></div>
										</div>
							...
							<ul class="gallery_items d-flex flex-row align-items-start justify-content-between flex-wrap">
								<li class="gallery_item">
									<a class="colorbox" href="https://images.unsplash.com/photo-1473625247510-8ceb1760943f?ixlib=rb-0.3.5&s=c0996cd16eda8c6f54c398de02d03cd3&auto=format&fit=crop&w=720&q=80">
										<img src="images/gallery_1.jpg" alt="Galerie Image 1">
									</a>
								</li>
								<li class="gallery_item">
									<a class="colorbox" href="https://images.unsplash.com/photo-1495162048225-6b3b37b8a69e?ixlib=rb-0.3.5&s=861dd3c7b9d3e735d7fd7cbb1eefed64&auto=format&fit=crop&w=720&q=80">
										<img src="images/gallery_2.jpg" alt="Galerie Image 2">
									</a>
								</li>
								<li class="gallery_item">
									<a class="colorbox" href="https://images.unsplash.com/photo-1502646275263-04be86afa386?ixlib=rb-0.3.5&s=682a41d7d9bf6e3feabc73a5fdd61dd2&auto=format&fit=crop&w=720&q=80">
										<img src="images/gallery_3.jpg" alt="Galerie Image 3">
									</a>
								</li>
								<li class="gallery_item">
									<a class="colorbox" href="https://images.unsplash.com/photo-1484820301304-0b43512779dc?ixlib=rb-0.3.5&s=7a3393e9f507fb4718c36337a8014c52&auto=format&fit=crop&w=720&q=80">
										<img src="images/gallery_4.jpg" alt="Galerie Image 4">
									</a>
								</li>
								<li class="gallery_item">
									<a class="colorbox" href="https://images.unsplash.com/photo-1490380169520-0a4b88d52565?ixlib=rb-0.3.5&s=7e6b68b1911fb4ffeea4c0750b8a5269&auto=format&fit=crop&w=720&q=80">
										<img src="images/gallery_5.jpg" alt="Galerie Image 5">
									</a>
								</li>
								<li class="gallery_item">
									<a class="colorbox" href="https://images.unsplash.com/photo-1504434026032-a7e440a30b68?ixlib=rb-0.3.5&s=2cc35bf903b78ba4f7f7ed69bc2abe3f&auto=format&fit=crop&w=720&q=80">
										<img src="images/gallery_6.jpg" alt="Galerie Image 6">
									</a>
								</li>
							</ul>
						</div>
