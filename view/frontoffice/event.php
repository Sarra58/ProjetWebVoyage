	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<li class="menu_item"><a href="#">offres</a></li>
						...
						<div class="col fill_height no-padding">
							...
							<div class="search_tabs_container">
								<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
									<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt="Icône valise"><span>Events</span></div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/bus.png" alt="Icône bus">location de voitures</div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/departure.png" alt="Icône avion">vols</div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/island.png" alt="Icône île">voyages</div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/cruise.png" alt="Icône croisière">croisières</div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/diving.png" alt="Icône plongée">activités</div>
								</div>
							</div>
					...
					<div class="offers_sorting_container">
						<ul class="offers_sorting">
							<li>
								...
								<ul>
									<li class="sort_btn active" data-isotope-option='{ "sortBy": "original-order" }' data-parent=".price_sorting"><span>tout montrer</span></li>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "price" }' data-parent=".price_sorting"><span>ascendant</span></li>
								</ul>
							</li>
							<li>
								<span class="sorting_text">lieu</span>
								<i class="fa fa-chevron-down"></i>
								<ul>
									<li class="sort_btn active" data-isotope-option='{ "sortBy": "original-order" }'><span>défaut</span></li>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "name" }'><span>alphabétique</span></li>
								</ul>
							</li>
							<li>
								<span class="sorting_text">étoiles</span>
								<i class="fa fa-chevron-down"></i>
								<ul>
									<li class="filter_btn active" data-filter="*"><span>tout montrer</span></li>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "stars" }'><span>ascendant</span></li>
							...
							<li class="distance_item">
								<span class="sorting_text">distance du centre</span>
								<i class="fa fa-chevron-down"></i>
								<ul>
							...
							<li>
								<span class="sorting_text">avis</span>
								<i class="fa fa-chevron-down"></i>
								<ul>
									<li class="num_sorting_btn"><span>avis</span></li>
									<li class="num_sorting_btn"><span>avis</span></li>
									<li class="num_sorting_btn"><span>avis</span></li>
								</ul>
							</li>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(../backoffice/<?= htmlspecialchars($Event['photo']); ?>)"></div>
										<div class="offer_name"><a href="single_listing.html"><?= htmlspecialchars($Event['titre']); ?></a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price"><?= htmlspecialchars($Event['titre']); ?><span><?= htmlspecialchars($Event['lieu']); ?></span></div>
										...
										<p class="offers_text"><?= htmlspecialchars($Event['description']); ?></p>
										...
										<div class="button book_button"><a href="#">réserver<span></span><span></span><span></span></a></div>
										<div class="offer_reviews">
											<div class="offer_reviews_content">
												<div class="offer_reviews_title">très bien</div>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="#">offres</a></li>
