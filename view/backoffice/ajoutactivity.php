...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        // Validation de type de fichier image
        ...
        if (move_uploaded_file($photo["tmp_name"], $targetFile)) {
            ...
            if ($controller->addActivity($Activity)) {
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">  ajout activity </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Tables</a></li>
                  <li class="breadcrumb-item active" aria-current="page">ajout activity</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ajout activity</h4>
                    <form action="ajoutactivity.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                      <label for="event_id">Event associé :</label><br>
